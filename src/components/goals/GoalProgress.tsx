...
const GoalProgress: React.FC<GoalProgressProps> = ({ goal, onUpdateProgress }) => {
  ...
  return (
    <div className="p-3 rounded" style={{ backgroundColor: '#f8f9fa' }}>
      <h6 className="ubuntu-font fw-bold mb-3" style={{ color: '#2c3e50' }}>Add Progress</h6>

      <Row className="g-2 mb-3">
        <Col md={6}>
          <Form.Group>
            <Form.Label className="small roboto-font">Amount (R)</Form.Label>
            <Form.Control
              type="number"
              value={amount}
        ...
        <Col md={6}>
          <Form.Group>
            <Form.Label className="small roboto-font">Description (Optional)</Form.Label>
            <Form.Control
              type="text"
              value={description}
      ...
      <Button
        ...
        disabled={amount <= 0}
        className="w-100 mb-3 roboto-font"
        style={{
      ...
      <div className="mt-3 pt-3 border-top">
        <small className="text-muted roboto-font d-block mb-1">
